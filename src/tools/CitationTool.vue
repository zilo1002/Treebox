    ...
    <div v-if="currentStep === 1" class="step-panel">
      <div class="ref-section">
        ...
        <div class="usage-tip">
          <strong>💡 使用说明</strong>
          <ol>
            <li>选择引用格式（GB/T 7714、APA 等）和文中标注样式（上标/下标/括号/作者-年份/脚注）</li>
            <li>在下方文本框粘贴参考文献，每行一条，支持 GB/T 7714 格式自动识别</li>
            <li>点击「解析参考文献」自动提取作者、标题、年份、出版社等信息</li>
            <li>进入「标注引用」步骤，在正文中选中文本即可插入引用标记</li>
          </ol>
        </div>
        ...
        <div class="format-hint">
          <p><strong>📘 引用格式：</strong>{{ formatDesc[citationStyle] }}</p>
          <p><strong>📍 引用位置：</strong>{{ positionDesc[citePosition] }}</p>
        </div>
...
const formatDesc = {
  gb7714: '中国国家标准，适用于中文学术论文，理工科最常用',
  apa7: '美国心理学会第7版，适用于社科、教育、心理学论文',
  mla9: '现代语言协会第9版，适用于人文、文学、艺术论文',
  chicago17: '芝加哥第17版，适用于历史、出版、部分社科论文',
}

const positionDesc = {
  superscript: '标注在正文右上角，如 正文[1]，理工科最常用',
  subscript: '标注在正文右下角，如 正文[1]，特定领域使用',
  bracket: '标注在正文行内括号中，如 正文[1]',
  authorYear: '标注在正文括号中，如 正文(张三, 2023)，APA/MLA常用',
  footnote: '标注在页面底部，如 正文①，人文社科常用',
}
...
.format-hint p + p { margin-top: 4px; }
